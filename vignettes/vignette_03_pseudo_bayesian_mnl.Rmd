...
# 25 secs
# 56 secs
X_q3_J5_s4_D_bayes_o3 = mixture_coord_ex_mnl(
  n_random_starts = 8,
  q = q,
  J = J,
  S = S,
...
```{r}
# 100 secs
X_q3_J5_s4_I_bayes_o3 = mixture_coord_ex_mnl(
  n_random_starts = 8,
  q = q,
  J = J,
  S = S,
...
# # 20 secs
# (t1 = Sys.time())
X_q3_J5_s4_D_bayes_o2 = mixture_coord_ex_mnl(
  n_random_starts = 8,
  q = q,
  J = J,
  S = S,
...
# # 26 secs
# (t1 = Sys.time())
X_q3_J5_s4_I_bayes_o2 = mixture_coord_ex_mnl(
  n_random_starts = 8,
  q = q,
  J = J,
  S = S,
...
# # 6 secs
# (t1 = Sys.time())
X_q3_J5_s4_D_bayes_o1 = mixture_coord_ex_mnl(
  n_random_starts = 8,
  q = q,
  J = J,
  S = S,
...
# # 18 secs
# (t1 = Sys.time())
X_q3_J5_s4_I_bayes_o1 = mixture_coord_ex_mnl(
  n_random_starts = 8,
  q = q,
  J = J,
  S = S,
...
# 42 secs
(t1 = Sys.time())
X_q4_J2_s10_D_bayes_o3 = mixture_coord_ex_mnl(
  n_random_starts = 4,
  q = q,
  J = J,
  S = S,
...
# 55 secs
(t1 = Sys.time())
X_q4_J2_s10_I_bayes_o3 = mixture_coord_ex_mnl(
  n_random_starts = 4,
  q = q,
  J = J,
  S = S,
