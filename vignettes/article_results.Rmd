...
fds_plot_cocktail = pred_vars_cocktail %>%
  ggplot() +
...
ggplot2:::print.ggplot(fds_plot_cocktail)
...
pred_vars_cornell = lapply(
  seq_along(cornell_designs), function(i){
    ...
    pred_vars_cornell_i = mnl_get_fds_simulations(
...
fds_plot_cornell = pred_vars_cornell %>%
  left_join(
...
ggplot2:::print.ggplot(fds_plot_cornell)
