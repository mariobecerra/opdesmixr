...
// getXsMNL
arma::mat getXsMNL(arma::cube& X, int s, int order, int n_pv);
RcppExport SEXP _opdesmixr_getXsMNL(SEXP XSEXP, SEXP sSEXP, SEXP orderSEXP, SEXP n_pvSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type order(orderSEXP);
    Rcpp::traits::input_parameter< int >::type n_pv(n_pvSEXP);
    rcpp_result_gen = Rcpp::wrap(getXsMNL(X, s, order, n_pv));
    return rcpp_result_gen;
END_RCPP
}
// getUsMNL
...
arma::mat getInformationMatrixMNL(arma::cube& X, arma::vec& beta, int order, bool transform_beta, int n_pv);
RcppExport SEXP _opdesmixr_getInformationMatrixMNL(SEXP XSEXP, SEXP betaSEXP, SEXP orderSEXP, SEXP transform_betaSEXP, SEXP n_pvSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::cube& >::type X(XSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type transform_beta(transform_betaSEXP);
    Rcpp::traits::input_parameter< int >::type n_pv(n_pvSEXP);
    rcpp_result_gen = Rcpp::wrap(getInformationMatrixMNL(X, beta, order, transform_beta, n_pv));
    return rcpp_result_gen;
END_RCPP
}
// getOptCritValueMNL
double getOptCritValueMNL(arma::cube& X, arma::mat& beta_mat, int verbose, int opt_crit, arma::mat& W, int order, bool transform_beta, int n_pv);
RcppExport SEXP _opdesmixr_getOptCritValueMNL(SEXP XSEXP, SEXP beta_matSEXP, SEXP verboseSEXP, SEXP opt_critSEXP, SEXP WSEXP, SEXP orderSEXP, SEXP transform_betaSEXP, SEXP n_pvSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::cube& >::type X(XSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type transform_beta(transform_betaSEXP);
    Rcpp::traits::input_parameter< int >::type n_pv(n_pvSEXP);
    rcpp_result_gen = Rcpp::wrap(getOptCritValueMNL(X, beta_mat, verbose, opt_crit, W, order, transform_beta, n_pv));
    return rcpp_result_gen;
END_RCPP
}
...
double efficiencyCoxScheffeMNL(double theta, arma::cube& X, arma::mat& beta_mat, int i, int j, int s, int opt_crit, arma::mat& W, int order, bool transform_beta, int n_pv);
RcppExport SEXP _opdesmixr_efficiencyCoxScheffeMNL(SEXP thetaSEXP, SEXP XSEXP, SEXP beta_matSEXP, SEXP iSEXP, SEXP jSEXP, SEXP sSEXP, SEXP opt_critSEXP, SEXP WSEXP, SEXP orderSEXP, SEXP transform_betaSEXP, SEXP n_pvSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type theta(thetaSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type transform_beta(transform_betaSEXP);
    Rcpp::traits::input_parameter< int >::type n_pv(n_pvSEXP);
    rcpp_result_gen = Rcpp::wrap(efficiencyCoxScheffeMNL(theta, X, beta_mat, i, j, s, opt_crit, W, order, transform_beta, n_pv));
    return rcpp_result_gen;
END_RCPP
}
// findBestCoxDirMNLBrent
void findBestCoxDirMNLBrent(arma::cube& X, arma::mat& beta_mat, int i, int j, int s, int opt_crit, int order, arma::mat& W, double lower, double upper, double tol, int verbose, bool transform_beta, int n_pv);
RcppExport SEXP _opdesmixr_findBestCoxDirMNLBrent(SEXP XSEXP, SEXP beta_matSEXP, SEXP iSEXP, SEXP jSEXP, SEXP sSEXP, SEXP opt_critSEXP, SEXP orderSEXP, SEXP WSEXP, SEXP lowerSEXP, SEXP upperSEXP, SEXP tolSEXP, SEXP verboseSEXP, SEXP transform_betaSEXP, SEXP n_pvSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::cube& >::type X(XSEXP);
    Rcpp::traits::input_parameter< arma::mat& >::type beta_mat(beta_matSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type transform_beta(transform_betaSEXP);
    Rcpp::traits::input_parameter< int >::type n_pv(n_pvSEXP);
    findBestCoxDirMNLBrent(X, beta_mat, i, j, s, opt_crit, order, W, lower, upper, tol, verbose, transform_beta, n_pv);
    return R_NilValue;
END_RCPP
}
// mixtureCoordinateExchangeMNL
Rcpp::List mixtureCoordinateExchangeMNL(arma::cube X_orig, arma::mat beta_mat, int order, int max_it, int verbose, int opt_crit, arma::mat W, int opt_method, double lower, double upper, double tol, int n_cox_points, bool transform_beta, int n_pv);
RcppExport SEXP _opdesmixr_mixtureCoordinateExchangeMNL(SEXP X_origSEXP, SEXP beta_matSEXP, SEXP orderSEXP, SEXP max_itSEXP, SEXP verboseSEXP, SEXP opt_critSEXP, SEXP WSEXP, SEXP opt_methodSEXP, SEXP lowerSEXP, SEXP upperSEXP, SEXP tolSEXP, SEXP n_cox_pointsSEXP, SEXP transform_betaSEXP, SEXP n_pvSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< bool >::type transform_beta(transform_betaSEXP);
    Rcpp::traits::input_parameter< int >::type n_pv(n_pvSEXP);
    rcpp_result_gen = Rcpp::wrap(mixtureCoordinateExchangeMNL(X_orig, beta_mat, order, max_it, verbose, opt_crit, W, opt_method, lower, upper, tol, n_cox_points, transform_beta, n_pv));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_opdesmixr_getXsMNL", (DL_FUNC) &_opdesmixr_getXsMNL, 4},
    {"_opdesmixr_getUsMNL", (DL_FUNC) &_opdesmixr_getUsMNL, 6},
    {"_opdesmixr_getPsMNL", (DL_FUNC) &_opdesmixr_getPsMNL, 6},
    {"_opdesmixr_getInformationMatrixMNL", (DL_FUNC) &_opdesmixr_getInformationMatrixMNL, 5},
    {"_opdesmixr_getOptCritValueMNL", (DL_FUNC) &_opdesmixr_getOptCritValueMNL, 8},
    ...
    {"_opdesmixr_efficiencyCoxScheffeMNL", (DL_FUNC) &_opdesmixr_efficiencyCoxScheffeMNL, 11},
    {"_opdesmixr_findBestCoxDirMNLBrent", (DL_FUNC) &_opdesmixr_findBestCoxDirMNLBrent, 14},
    {"_opdesmixr_mixtureCoordinateExchangeMNL", (DL_FUNC) &_opdesmixr_mixtureCoordinateExchangeMNL, 14},
    {NULL, NULL, 0}
};
